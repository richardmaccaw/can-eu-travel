const paragraphs = [
  ...
  "My wife had already glided through passport control, practically applauded through by the border guard. Swedish passport. No queue. No fuss. Just a smile and a wave on through",
